...
window.dom = {
  ...
  create: function create(string) {
    var container = document.createElement('template'); //容器
  ...
  wrap: function wrap(node, parent) {
    dom.before(node, parent); //先添加新节点到原先节点前面

    dom.append(parent, node); //再把原先的节点添加为新节点的儿子
  },
  //删
  //删节点
  ...
  find: function find(selector, scope) {
    return (scope || document).querySelectorAll(selector); //如果有scope，就在scope里找selector；否则就在document里找
  },
  //获取父元素
